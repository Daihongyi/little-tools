...
def main():
    ...
    main_window.title("little tools 1.1")
    ...
    def handle_new_edition():
        messagebox.showinfo("新版本介绍","版本号:1.1 更新内容:窗口按钮布局，文字内容，新增功能：新版本介绍")
    ...
    button_decrypt = tk.Button(main_window, text="新版本介绍", command=handle_new_edition)
    button_decrypt.place(x=400, y=350)

    button_exit = tk.Button(main_window, text="退出", command=handle_exit)
    button_exit.place(x=300,y=350)
    ...
    about4 = tk.Label(main_window,text="邮箱：17717460527@163.com\n2052552804@qq.com\ndaihongyi2024@gmail.com",fg="red")
    about1.place(y=150)
    about2.place(y=200)
    about3.place(y=250)
    about4.place(y=300)
